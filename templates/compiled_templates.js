...
this["templates"]["gallery"] = Handlebars.template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"gallery_wrapper\" id=\"gal_wrapper"
    ...
    + "\" src=\"../control_graphic/back_icon.png\" onclick=\"left_click()\">\r\n    <img class=\"gal_right_click\" id=\"grc"
    ...
    + "\" src=\"../control_graphic/right.png\" onclick=\"right_click()\">\r\n    <div class=\"gall_num\" id=\"g_num"
...
this["templates"]["player"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "    <a-entity my-gltf-model=\"#main_model\" id=\"gltf_model\" big_model autoscale=\" scale:"
    + alias4(((helper = (helper = lookupProperty(helpers,"model_scale") || (depth0 != null ? lookupProperty(depth0,"model_scale") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"model_scale","hash":{},"data":data,"loc":{"start":{"line":21,"column":86},"end":{"line":21,"column":101}}}) : helper)))
    + "; rotation: "
    + alias4(((helper = (helper = lookupProperty(helpers,"model_rotation") || (depth0 != null ? lookupProperty(depth0,"model_rotation") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"model_rotation","hash":{},"data":data,"loc":{"start":{"line":21,"column":113},"end":{"line":21,"column":131}}}) : helper)))
    + "\"></a-entity>\r\n";
  ...
  return "<a-scene  background=\" color: "
    ...
    + ((stack1 = (lookupProperty(helpers,"if_equals")||(depth0 && lookupProperty(depth0,"if_equals"))||alias2).call(alias1,(depth0 != null ? lookupProperty(depth0,"model_src") : depth0),"",{"name":"if_equals","hash":{},"fn":container.program(5, data, 0),"inverse":container.program(7, data, 0),"data":data,"loc":{"start":{"line":14,"column":8},"end":{"line":17,"column":22}}})) != null ? stack1 : "")
    + "    </a-assets>\r\n"
    + ((stack1 = (lookupProperty(helpers,"if_equals")||(depth0 && lookupProperty(depth0,"if_equals"))||alias2).call(alias1,(depth0 != null ? lookupProperty(depth0,"model_src") : depth0),"",{"name":"if_equals","hash":{},"fn":container.program(5, data, 0),"inverse":container.program(9, data, 0),"data":data,"loc":{"start":{"line":19,"column":4},"end":{"line":22,"column":18}}})) != null ? stack1 : "")
...
this["templates"]["popup"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data,blockParams,depths) {
  ...
  return "<div class=\"popup\" id=\""
    ...
    + "</span> </div>\r\n"
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,(depths[1] != null ? lookupProperty(depths[1],"edit_mode") : depths[1]),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams, depths),"inverse":container.noop,"data":data,"loc":{"start":{"line":5,"column":4},"end":{"line":7,"column":11}}})) != null ? stack1 : "")
    + "</div>\r\n";
},"2":function(container,depth0,helpers,partials,data) {
    var helper, lookupProperty = container.lookupProperty || function(parent, propertyName) {
        if (Object.prototype.hasOwnProperty.call(parent, propertyName)) {
  ...
  return "        <button class=\"button ed_button\" id=\"edit"
    + container.escapeExpression(((helper = (helper = lookupProperty(helpers,"key") || (data && lookupProperty(data,"key"))) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"key","hash":{},"data":data,"loc":{"start":{"line":6,"column":49},"end":{"line":6,"column":57}}}) : helper)))
    + "\">Upravit</button>\r\n";
...
this["templates"]["popup_button"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<a-text \r\n    value=\""
    ...
    + alias3(((helper = (helper = lookupProperty(helpers,"key") || (data && lookupProperty(data,"key"))) != null ? helper : alias2),(typeof helper === alias4 ? helper.call(alias1,{"name":"key","hash":{},"data":data,"loc":{"start":{"line":5,"column":46},"end":{"line":5,"column":54}}}) : helper)))
    + "\" position=\""
    + alias3(((helper = (helper = lookupProperty(helpers,"position") || (depth0 != null ? lookupProperty(depth0,"position") : depth0)) != null ? helper : alias2),(typeof helper === alias4 ? helper.call(alias1,{"name":"position","hash":{},"data":data,"loc":{"start":{"line":5,"column":66},"end":{"line":5,"column":78}}}) : helper)))
    + "\" data-clickable\r\n></a-text>\r\n";
},"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1, lookupProperty = container.lookupProperty || function(parent, propertyName) {
        if (Object.prototype.hasOwnProperty.call(parent, propertyName)) {
