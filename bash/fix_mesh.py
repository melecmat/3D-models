...
def get_program_parameters():
    ...
    parser.add_argument('filename_out', nargs='?', default=None, help='Name of output')
    parser.add_argument('reduction', nargs='?', type = float, default=.9, help='Sets the decimation target reduction, (default is 0.9).')
    args = parser.parse_args()
    return args.filename, args.filename_out, args.reduction


def main():
    filePath, outFilePath, reduction = get_program_parameters()
    ...
    plyWriter.SetFileName(outFilePath)
